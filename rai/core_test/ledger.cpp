...
TEST (ledger, receive_rollback)
{
	...
	auto transaction (store.tx_begin (true));
	store.initialize (transaction, genesis);
	rai::send_block send (genesis.hash (), rai::test_genesis_key.pub, rai::genesis_amount - rai::Gbcb_ratio, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send).code);
...
TEST (votes, add_existing)
{
	...
	rai::genesis genesis;
	rai::keypair key1;
	auto send1 (std::make_shared<rai::send_block> (genesis.hash (), key1.pub, rai::genesis_amount - rai::Gbcb_ratio, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0));
	{
		auto transaction (node1.store.tx_begin (true));
		ASSERT_EQ (rai::process_result::progress, node1.ledger.process (transaction, *send1).code);
	}
	...
	rai::keypair key2;
	auto send2 (std::make_shared<rai::send_block> (genesis.hash (), key2.pub, rai::genesis_amount - rai::Gbcb_ratio, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0));
...
TEST (ledger, state_account)
{
	...
	auto transaction (store.tx_begin (true));
	store.initialize (transaction, genesis);
	rai::state_block send1 (rai::genesis_account, genesis.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio, rai::genesis_account, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send1).code);
...
TEST (ledger, state_send_receive)
{
	...
	ASSERT_EQ (rai::genesis_amount - rai::Gbcb_ratio, ledger.balance (transaction, send1.hash ()));
	ASSERT_EQ (rai::Gbcb_ratio, ledger.amount (transaction, send1.hash ()));
	ASSERT_EQ (rai::genesis_amount - rai::Gbcb_ratio, ledger.weight (transaction, rai::genesis_account));
	...
	ASSERT_EQ (rai::Gbcb_ratio, ledger.amount (transaction, receive1.hash ()));
	ASSERT_EQ (rai::genesis_amount, ledger.weight (transaction, rai::genesis_account));
...
TEST (ledger, state_receive)
{
	...
	auto transaction (store.tx_begin (true));
	store.initialize (transaction, genesis);
	rai::send_block send1 (genesis.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send1).code);
	ASSERT_TRUE (store.block_exists (transaction, send1.hash ()));
	auto send2 (store.block_get (transaction, send1.hash ()));
	ASSERT_NE (nullptr, send2);
...
TEST (ledger, state_open)
{
	...
	rai::state_block send1 (rai::genesis_account, genesis.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio, destination.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send1).code);
	ASSERT_TRUE (store.block_exists (transaction, send1.hash ()));
	auto send2 (store.block_get (transaction, send1.hash ()));
	ASSERT_NE (nullptr, send2);
	...
	rai::state_block open1 (destination.pub, 0, rai::genesis_account, rai::Gbcb_ratio, send1.hash (), destination.prv, destination.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, open1).code);
	...
	ASSERT_EQ (rai::Gbcb_ratio, ledger.balance (transaction, open1.hash ()));
	ASSERT_EQ (rai::Gbcb_ratio, ledger.amount (transaction, open1.hash ()));
	ASSERT_EQ (rai::genesis_amount, ledger.weight (transaction, rai::genesis_account));
}
...
TEST (ledger, send_after_state_fail)
{
	...
	rai::state_block send1 (rai::genesis_account, genesis.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio, rai::genesis_account, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send1).code);
	rai::send_block send2 (send1.hash (), rai::genesis_account, rai::genesis_amount - (2 * rai::Gbcb_ratio), rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
...
TEST (ledger, state_receive_bad_amount_fail)
{
	...
	ASSERT_EQ (rai::Gbcb_ratio, ledger.amount (transaction, send1.hash ()));
	ASSERT_EQ (rai::genesis_amount - rai::Gbcb_ratio, ledger.weight (transaction, rai::genesis_account));
	rai::state_block receive1 (rai::genesis_account, send1.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio, send1.hash (), rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
...
TEST (ledger, state_receive_wrong_account_fail)
{
	...
	ASSERT_EQ (rai::genesis_amount - rai::Gbcb_ratio, ledger.weight (transaction, rai::genesis_account));
	rai::keypair key;
	rai::state_block receive1 (key.pub, 0, rai::genesis_account, rai::Gbcb_ratio, send1.hash (), key.prv, key.pub, 0);
	ASSERT_EQ (rai::process_result::unreceivable, ledger.process (transaction, receive1).code);
}
...
TEST (ledger, state_state_open_fork)
{
	...
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, open1).code);
	rai::state_block open2 (destination.pub, 0, rai::genesis_account, rai::Gbcb_ratio, send1.hash (), destination.prv, destination.pub, 0);
	ASSERT_EQ (rai::process_result::fork, ledger.process (transaction, open2).code);
	ASSERT_EQ (open1.root (), open2.root ());
}
...
TEST (ledger, state_open_previous_fail)
{
	...
	rai::state_block send1 (rai::genesis_account, genesis.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio, destination.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send1).code);
	rai::state_block open1 (destination.pub, destination.pub, rai::genesis_account, rai::Gbcb_ratio, send1.hash (), destination.prv, destination.pub, 0);
...
TEST (ledger, state_send_change)
{
	...
	store.initialize (transaction, genesis);
	rai::keypair rep;
	rai::state_block send1 (rai::genesis_account, genesis.hash (), rep.pub, rai::genesis_amount - rai::Gbcb_ratio, rai::genesis_account, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send1).code);
	ASSERT_TRUE (store.block_exists (transaction, send1.hash ()));
	auto send2 (store.block_get (transaction, send1.hash ()));
	ASSERT_NE (nullptr, send2);
	...
	ASSERT_EQ (rai::Gbcb_ratio, ledger.amount (transaction, send1.hash ()));
	ASSERT_EQ (0, ledger.weight (transaction, rai::genesis_account));
	ASSERT_EQ (rai::genesis_amount - rai::Gbcb_ratio, ledger.weight (transaction, rep.pub));
}
...
TEST (ledger, state_receive_old)
{
	...
	rai::state_block send1 (rai::genesis_account, genesis.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio, destination.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send1).code);
	rai::state_block send2 (rai::genesis_account, send1.hash (), rai::genesis_account, rai::genesis_amount - (2 * rai::Gbcb_ratio), destination.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send2).code);
	rai::open_block open1 (send1.hash (), rai::genesis_account, destination.pub, destination.prv, destination.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, open1).code);
	rai::receive_block receive1 (open1.hash (), send2.hash (), destination.prv, destination.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, receive1).code);
	ASSERT_EQ (2 * rai::Gbcb_ratio, ledger.balance (transaction, receive1.hash ()));
	ASSERT_EQ (rai::Gbcb_ratio, ledger.amount (transaction, receive1.hash ()));
	ASSERT_EQ (rai::genesis_amount, ledger.weight (transaction, rai::genesis_account));
}
...
TEST (ledger, state_rollback_send)
{
	...
	ASSERT_NE (nullptr, send2);
	ASSERT_EQ (send1, *send2);
	ASSERT_EQ (rai::genesis_amount - rai::Gbcb_ratio, ledger.account_balance (transaction, rai::genesis_account));
	ASSERT_EQ (rai::genesis_amount - rai::Gbcb_ratio, ledger.weight (transaction, rai::genesis_account));
	...
	ASSERT_EQ (rai::Gbcb_ratio, info.amount.number ());
	ledger.rollback (transaction, send1.hash ());
...
TEST (ledger, state_rollback_received_send)
{
	...
	store.initialize (transaction, genesis);
	rai::keypair key;
	rai::state_block send1 (rai::genesis_account, genesis.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio, key.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send1).code);
	rai::state_block receive1 (key.pub, 0, key.pub, rai::Gbcb_ratio, send1.hash (), key.prv, key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, receive1).code);
	ASSERT_FALSE (store.pending_exists (transaction, rai::pending_key (rai::genesis_account, receive1.hash ())));
	ledger.rollback (transaction, send1.hash ());
	ASSERT_FALSE (store.pending_exists (transaction, rai::pending_key (rai::genesis_account, send1.hash ())));
...
TEST (ledger, epoch_blocks_general)
{
	...
	ASSERT_EQ (rai::process_result::block_position, ledger.process (transaction, change1).code);
	rai::state_block send1 (rai::genesis_account, epoch1.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio, destination.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send1).code);
	rai::open_block open1 (send1.hash (), rai::genesis_account, destination.pub, destination.prv, destination.pub, 0);
	...
	ASSERT_EQ (rai::process_result::block_position, ledger.process (transaction, receive1).code);
	rai::state_block receive2 (destination.pub, epoch4.hash (), destination.pub, rai::Gbcb_ratio, send1.hash (), destination.prv, destination.pub, 0);
	...
	ASSERT_EQ (rai::Gbcb_ratio, ledger.balance (transaction, receive2.hash ()));
	ASSERT_EQ (rai::Gbcb_ratio, ledger.amount (transaction, receive2.hash ()));
	ASSERT_EQ (rai::genesis_amount - rai::Gbcb_ratio, ledger.weight (transaction, rai::genesis_account));
	ASSERT_EQ (rai::Gbcb_ratio, ledger.weight (transaction, destination.pub));
}
...
TEST (ledger, epoch_blocks_receive_upgrade)
{
	...
	rai::state_block send1 (rai::genesis_account, genesis.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio, destination.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send1).code);
	rai::state_block epoch1 (rai::genesis_account, send1.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio, 123, epoch_key.prv, epoch_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, epoch1).code);
	rai::state_block send2 (rai::genesis_account, epoch1.hash (), rai::genesis_account, rai::genesis_amount - rai::Gbcb_ratio * 2, destination.pub, rai::test_genesis_key.prv, rai::test_genesis_key.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, send2).code);
	rai::open_block open1 (send1.hash (), destination.pub, destination.pub, destination.prv, destination.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, open1).code);
	rai::receive_block receive1 (open1.hash (), send2.hash (), destination.prv, destination.pub, 0);
	ASSERT_EQ (rai::process_result::unreceivable, ledger.process (transaction, receive1).code);
	rai::state_block receive2 (destination.pub, open1.hash (), destination.pub, rai::Gbcb_ratio * 2, send2.hash (), destination.prv, destination.pub, 0);
	ASSERT_EQ (rai::process_result::progress, ledger.process (transaction, receive2).code);
	...
	rai::state_block send3 (destination.pub, receive2.hash (), destination.pub, rai::Gbcb_ratio, destination2.pub, destination.prv, destination.pub, 0);
