...
{
	ASSERT_EQ ("0", rai::amount (rai::uint128_t ("0")).format_balance (rai::Mbcb_ratio, 0, false));
	ASSERT_EQ ("0", rai::amount (rai::uint128_t ("0")).format_balance (rai::Mbcb_ratio, 2, true));
	ASSERT_EQ ("340,282,366", rai::amount (rai::uint128_t ("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")).format_balance (rai::Mbcb_ratio, 0, true));
	ASSERT_EQ ("340,282,366.920938463463374607431768211455", rai::amount (rai::uint128_t ("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")).format_balance (rai::Mbcb_ratio, 64, true));
	...
	ASSERT_EQ ("340,282,366", rai::amount (rai::uint128_t ("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE")).format_balance (rai::Mbcb_ratio, 0, true));
	ASSERT_EQ ("340,282,366.920938463463374607431768211454", rai::amount (rai::uint128_t ("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE")).format_balance (rai::Mbcb_ratio, 64, true));
	...
	ASSERT_EQ ("170,141,183", rai::amount (rai::uint128_t ("0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE")).format_balance (rai::Mbcb_ratio, 0, true));
	ASSERT_EQ ("170,141,183.460469231731687303715884105726", rai::amount (rai::uint128_t ("0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE")).format_balance (rai::Mbcb_ratio, 64, true));
	...
	ASSERT_EQ ("1", rai::amount (rai::uint128_t ("1000000000000000000000000000000")).format_balance (rai::Mbcb_ratio, 2, true));
	ASSERT_EQ ("1.2", rai::amount (rai::uint128_t ("1200000000000000000000000000000")).format_balance (rai::Mbcb_ratio, 2, true));
	ASSERT_EQ ("1.23", rai::amount (rai::uint128_t ("1230000000000000000000000000000")).format_balance (rai::Mbcb_ratio, 2, true));
	ASSERT_EQ ("1.2", rai::amount (rai::uint128_t ("1230000000000000000000000000000")).format_balance (rai::Mbcb_ratio, 1, true));
	ASSERT_EQ ("1", rai::amount (rai::uint128_t ("1230000000000000000000000000000")).format_balance (rai::Mbcb_ratio, 0, true));
	ASSERT_EQ ("< 0.01", rai::amount (rai::bcb_ratio * 10).format_balance (rai::Mbcb_ratio, 2, true));
	ASSERT_EQ ("< 0.1", rai::amount (rai::bcb_ratio * 10).format_balance (rai::Mbcb_ratio, 1, true));
	ASSERT_EQ ("< 1", rai::amount (rai::bcb_ratio * 10).format_balance (rai::Mbcb_ratio, 0, true));
	ASSERT_EQ ("< 0.01", rai::amount (rai::bcb_ratio * 9999).format_balance (rai::Mbcb_ratio, 2, true));
	ASSERT_EQ ("0.01", rai::amount (rai::bcb_ratio * 10000).format_balance (rai::Mbcb_ratio, 2, true));
	ASSERT_EQ ("123456789", rai::amount (rai::Mbcb_ratio * 123456789).format_balance (rai::Mbcb_ratio, 2, false));
	ASSERT_EQ ("123,456,789", rai::amount (rai::Mbcb_ratio * 123456789).format_balance (rai::Mbcb_ratio, 2, true));
	ASSERT_EQ ("123,456,789.12", rai::amount (rai::Mbcb_ratio * 123456789 + rai::kbcb_ratio * 123).format_balance (rai::Mbcb_ratio, 2, true));
	ASSERT_EQ ("12-3456-789+123", rai::amount (rai::Mbcb_ratio * 123456789 + rai::kbcb_ratio * 123).format_balance (rai::Mbcb_ratio, 4, true, std::locale (std::cout.getloc (), new test_punct)));
}
