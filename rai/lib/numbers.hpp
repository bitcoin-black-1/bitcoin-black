...
// SI dividers
rai::uint128_t const Gbcb_ratio = rai::uint128_t ("10000000000000000000000000000000"); // 10^33
rai::uint128_t const Mbcb_ratio = rai::uint128_t ("10000000000000000000000000000"); // 10^30
rai::uint128_t const kbcb_ratio = rai::uint128_t ("10000000000000000000000000"); // 10^27
rai::uint128_t const bcb_ratio = rai::uint128_t ("10000000000000000000000"); // 10^24
rai::uint128_t const mbcb_ratio = rai::uint128_t ("10000000000000000000"); // 10^21
rai::uint128_t const ubcb_ratio = rai::uint128_t ("10000000000000000"); // 10^18
