...
opencl (opencl_a)
{
	...
	auto count (rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_test_network ? 1 : std::min (max_threads_a, std::max (1u, std::thread::hardware_concurrency ())));
