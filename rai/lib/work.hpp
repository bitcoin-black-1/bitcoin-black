...
public:
	...
	static uint64_t const publish_threshold = rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_test_network ? publish_test_threshold : publish_full_threshold;
};
}
