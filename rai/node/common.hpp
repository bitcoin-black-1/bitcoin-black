...
public:
	...
	static std::array<uint8_t, 2> constexpr magic_number = rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_test_network ? std::array<uint8_t, 2>{ { 'R', 'A' } } : rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_beta_network ? std::array<uint8_t, 2>{ { 'R', 'B' } } : std::array<uint8_t, 2>{ { 'R', 'C' } };
	uint8_t version_max;
