...
public:
	...
	static unsigned constexpr announce_interval_ms = (rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_test_network) ? 10 : 16000;
...
public:
	...
	static int constexpr mapping_timeout = rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_test_network ? 53 : 3593;
	static int constexpr check_timeout = rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_test_network ? 17 : 53;
...
public:
	...
	rai::node & node;
	bool on;
	static uint16_t const node_port = rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_live_network ? 7078 : 54000;
};
class logging
{
public:
