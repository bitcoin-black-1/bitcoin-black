...
__kernel void bitcoinblack_work (__global ulong * attempt, __global ulong * result_a, __global uchar * item_a)
{
							...
							if (!error_a)
							{
								...
								if (!error_a)
								{
									...
									if (!error_a)
									{
										...
										kernel = clCreateKernel (program, "bitcoinblack_work", &kernel_error);
