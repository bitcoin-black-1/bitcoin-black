...
public:
	...
	rai::node & node;
	bool on;
	static uint16_t const rpc_port = rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_live_network ? 7079 : 55000;
};
...
public:
	...
	void key_expand ();
	void ledger ();
	void mbcb_to_raw (rai::uint128_t = rai::Mbcb_ratio);
	void mbcb_from_raw (rai::uint128_t = rai::Mbcb_ratio);
