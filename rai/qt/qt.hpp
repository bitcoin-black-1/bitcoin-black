...
{
public:
	settings (bitcoinblack_qt::wallet &);
	...
	QPushButton * back;
	bitcoinblack_qt::wallet & wallet;
};
class advanced_actions
{
public:
	advanced_actions (bitcoinblack_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
...
{
public:
	block_entry (bitcoinblack_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
...
{
public:
	block_creation (bitcoinblack_qt::wallet &);
	void deactivate_all ();
	void activate_send ();
...
{
public:
	self_pane (bitcoinblack_qt::wallet &, rai::account const &);
...
{
public:
	accounts (bitcoinblack_qt::wallet &);
	void refresh ();
...
{
public:
	history (rai::ledger &, rai::account const &, bitcoinblack_qt::wallet &);
	void refresh ();
	QWidget * window;
	QVBoxLayout * layout;
	QStandardItemModel * model;
...
{
public:
	block_viewer (bitcoinblack_qt::wallet &);
...
{
public:
	account_viewer (bitcoinblack_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
	QLabel * account_label;
	...
	QHBoxLayout * balance_layout;
	QLabel * balance_label;
	bitcoinblack_qt::history history;
	QPushButton * back;
	rai::account account;
	bitcoinblack_qt::wallet & wallet;
};
...
{
public:
	stats_viewer (bitcoinblack_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
	QPushButton * refresh;
	QStandardItemModel * model;
...
{
public:
	status (bitcoinblack_qt::wallet &);
	void erase (bitcoinblack_qt::status_types);
	void insert (bitcoinblack_qt::status_types);
	void set_text ();
	std::string text ();
	std::string color ();
	std::set<bitcoinblack_qt::status_types> active;
	bitcoinblack_qt::wallet & wallet;
};
class wallet : public std::enable_shared_from_this<bitcoinblack_qt::wallet>
{
public:
	wallet (QApplication &, bitcoinblack_qt::eventloop_processor &, rai::node &, std::shared_ptr<rai::wallet>, rai::account &);
	void start ();
	void refresh ();
	...
	bitcoinblack_qt::history history;
	bitcoinblack_qt::accounts accounts;
	bitcoinblack_qt::self_pane self;
	bitcoinblack_qt::settings settings;
	bitcoinblack_qt::advanced_actions advanced;
	bitcoinblack_qt::block_creation block_creation;
	bitcoinblack_qt::block_entry block_entry;
	bitcoinblack_qt::block_viewer block_viewer;
	bitcoinblack_qt::account_viewer account_viewer;
	bitcoinblack_qt::stats_viewer stats_viewer;
	bitcoinblack_qt::import import;
	...
	bitcoinblack_qt::status active_status;
	void pop_main_stack ();
