...
int main (int argc, char ** argv)
{
	...
	std::vector<std::unique_ptr<bitcoinblack_qt::wallet>> guis;
	for (auto i (0); i < count; ++i)
	{
		...
		guis.push_back (std::unique_ptr<bitcoinblack_qt::wallet> (new bitcoinblack_qt::wallet (application, processor, *system.nodes[i], wallet, key.pub)));
