...
bitcoinblack_daemon::daemon_config::daemon_config (boost::filesystem::path const & application_path_a) :
rpc_enable (false),
opencl_enable (false)
{
}

void bitcoinblack_daemon::daemon_config::serialize_json (boost::property_tree::ptree & tree_a)
{
...
bool bitcoinblack_daemon::daemon_config::deserialize_json (bool & upgraded_a, boost::property_tree::ptree & tree_a)
{
	auto error (false);
	try
	{
...
bool bitcoinblack_daemon::daemon_config::upgrade_json (unsigned version_a, boost::property_tree::ptree & tree_a)
{
	auto result (false);
	switch (version_a)
	{
...
void bitcoinblack_daemon::daemon::run (boost::filesystem::path const & data_path)
{
	boost::system::error_code error_chmod;
	boost::filesystem::create_directories (data_path);
	boost::filesystem::permissions (data_path, boost::filesystem::owner_all, error_chmod);
	bitcoinblack_daemon::daemon_config config (data_path);
