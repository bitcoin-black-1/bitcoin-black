...
char const * test_public_key_data = "E89208DD038FBB269987689621D52292AE9C35941A7484756ECCED92A65093BA"; // bcb_3e3j5tkog48pnny9dmfzj1r16pg8t1e76dz5tmac6iq689wyjfpiij4txtdo
...
char const * live_public_key_data = "54C63730AECFB2E134323F653F775F9866E70E4EC0D73A423064440DE9A80D83"; // bcb_1o888wrcxmxkw6t56hu79xuoz858ww96xi8q9b351s463qnti5e59xwdtxbs
...
char const * test_genesis_data = R"%%%({
	...
	"representative": "bcb_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3",
	"account": "bcb_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3",
...
char const * live_genesis_data = R"%%%({
	"type": "open",
	"source": "54C63730AECFB2E134323F653F775F9866E70E4EC0D73A423064440DE9A80D83",
	"representative": "bcb_1o888wrcxmxkw6t56hu79xuoz858ww96xi8q9b351s463qnti5e59xwdtxbs",
	"account": "bcb_1o888wrcxmxkw6t56hu79xuoz858ww96xi8q9b351s463qnti5e59xwdtxbs",
	"work": "b4d2e853d8b7bc31",
	"signature": "3146E96FCC180CA63AE4EA02131635862E9125C91D4D878D81AE39A8817B9817D0389BF980BC7A26CFF6880AECF602A4C5724F6C4D3B7971629C2BF5FE7FE109"
})%%%";
...
public:
	...
	bitcoinblack_test_account (test_public_key_data),
	bitcoinblack_beta_account (beta_public_key_data),
	bitcoinblack_live_account (live_public_key_data),
	bitcoinblack_test_genesis (test_genesis_data),
	bitcoinblack_beta_genesis (beta_genesis_data),
	bitcoinblack_live_genesis (live_genesis_data),
	genesis_account (rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_test_network ? bitcoinblack_test_account : rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_beta_network ? bitcoinblack_beta_account : bitcoinblack_live_account),
	genesis_block (rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_test_network ? bitcoinblack_test_genesis : rai::bitcoinblack_network == rai::bitcoinblack_networks::bitcoinblack_beta_network ? bitcoinblack_beta_genesis : bitcoinblack_live_genesis),
	//genesis_amount (std::numeric_limits<rai::uint128_t>::max ()),
	genesis_amount ("360000000000000000000000000000000"), // 360 bil
	burn_account (0)
	{
	...
	rai::account bitcoinblack_test_account;
	rai::account bitcoinblack_beta_account;
	rai::account bitcoinblack_live_account;
	std::string bitcoinblack_test_genesis;
	std::string bitcoinblack_beta_genesis;
	std::string bitcoinblack_live_genesis;
...
rai::account const & rai::bitcoinblack_test_account (globals.bitcoinblack_test_account);
rai::account const & rai::bitcoinblack_beta_account (globals.bitcoinblack_beta_account);
rai::account const & rai::bitcoinblack_live_account (globals.bitcoinblack_live_account);
std::string const & rai::bitcoinblack_test_genesis (globals.bitcoinblack_test_genesis);
std::string const & rai::bitcoinblack_beta_genesis (globals.bitcoinblack_beta_genesis);
std::string const & rai::bitcoinblack_live_genesis (globals.bitcoinblack_live_genesis);
		...
		if (!current_amount.is_zero ())
		{
			...
			else
			{
				if (block_hash == rai::genesis_account)
				{
					...
					amount = rai::genesis_amount;	// Mstar
					current_amount = 0;
				}
				else
				{
