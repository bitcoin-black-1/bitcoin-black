...
extern rai::account const & bitcoinblack_test_account;
extern rai::account const & bitcoinblack_beta_account;
extern rai::account const & bitcoinblack_live_account;
extern std::string const & bitcoinblack_test_genesis;
extern std::string const & bitcoinblack_beta_genesis;
extern std::string const & bitcoinblack_live_genesis;
